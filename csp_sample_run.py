...
print("Plain Bactracking on simple CSP, with DH & LCV")
btracker.bt_search(prop_BT,ord_dh,val_lcv)
print("=======================================================")
print("Plain Bactracking on simple CSP, with MRV & LCV")
btracker.bt_search(prop_BT,ord_mrv,val_lcv)
...
solve_nQueens(8, 'BT', ord_mrv, val_lcv, trace)
print("=======================================================")
print("Plain Bactracking on 8-queens w/DH & LCV")
solve_nQueens(8, 'BT', ord_dh, val_lcv, trace)
print("=======================================================")
